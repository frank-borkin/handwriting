...
$html="<html><head><style>@font-face { font-family: '{$f}'; src: url('{$n}.woff')  format('woff'), url('{$n}.ttf')  format('truetype');} body, div {font-family: '{$f}';}</style></head><body><div>{$_REQUEST['story']}<div></body></html>";
